...
<input v-model="formData.tanggal" type="date" class="form-control mx-3"  style="width: 250px"   id="formGroupExampleInput2" placeholder="tanggal">
</div>
<div class="mb-3">
<label class="form-label p-3 my-0">isi</label>
<input v-model="formData.isi" type="text" class="form-control mx-3" style="width: 250px"  id="formGroupExampleInput2" placeholder="isi">
</div>
<div class="mb-3">
...
export default{
  ...
  mounted() {
    ...
    this.$axios.get(`/api/web/catatan/${this.$route.params.id}`)
  ...
  async updateCatatan() {
    try {
      await this.$axios.put(`/api/web/catatan/update/${this.$route.params.id}`, this.formData);
