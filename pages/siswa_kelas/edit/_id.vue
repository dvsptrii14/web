...
<div class="mb-3">
  ...
  <input v-model="formData.kelasjurusan_id" type="text" class="form-control mx-3" style="width: 250px;" id="formGroupExampleInput" placeholder="masukan kelas jurusan Id">
</div>

<div class="mb-3">
  <label class="form-label p-3 my-0">siswa id</label>
  <input v-model="formData.siswa_id" type="text" class="form-control mx-3" style="width: 250px;" id="formGroupExampleInput2" placeholder="masukan siswa id">
</div>

<div class="mb-3">
  <label class="form-label p-3 my-0">keterangan</label>
  <input v-model="formData.keterangan" type="text" class="form-control mx-3" style="width: 250px;" id="formGroupExampleInput2" placeholder="masukan keterangan">
</div>
...
export default{
    ...
    mounted() {
      ...
      this.$axios.get(`/api/web/siswa_kelas/${this.$route.params.id}`)
    ...
    methods:{
        async  updateSiswa_kelas(){
            try{
                await this.$axios.put(`/api/web/siswa_kelas/update/${this.$route.params.id}`, this.formData);
