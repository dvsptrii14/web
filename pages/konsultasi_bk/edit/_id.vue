        ...
        <form @submit.prevent="submitForm">
          <div class="mb-3">
            ...
            <input
              ...
              placeholder="masukan tujuan konsultasi anda"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              style="width: 250px"
              id="formGroupExampleInput2"
              placeholder="status jadwal konsultasi"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              style="width: 250px"
              id="formGroupExampleInput"
              placeholder="tempat konsultasi dilaksanakan"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              style="width: 250px"
              id="formGroupExampleInput"
              placeholder="jam konsultasi dilaksanakan"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              style="width: 250px"
              id="formGroupExampleInput"
              placeholder="id siswa yang konsultasi"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              style="width: 250px"
              id="formGroupExampleInput"
              placeholder="id guru yang melayani konsultasi"
            />
          </div>
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/web/konsultasi_bk/${this.$route.params.id}`)
    ...
    async updateKonsultasi_bk() {
      try {
        await this.$axios.put(
          `/api/web/konsultasi_bk/update/${this.$route.params.id}`,
          this.formData
        );
