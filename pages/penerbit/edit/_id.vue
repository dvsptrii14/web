<template>
  ...
  <input v-model="formData.penerbit" type="text" class="form-control mx-3"  style="width: 250px;" id="formGroupExampleInput" placeholder="penerbit">
</div>
<div class="mb-3">
...
<div class="mb-3">
  ...
  <input v-model="formData.telp_kantor" type="text" class="form-control mx-3" style="width: 250px"  id="formGroupExampleInput2" placeholder="telepon_kantor">
</div>
<div class="mb-3">
...
<div class="mb-3">
  ...
  <input v-model="formData.telp_kontak" type="text" class="form-control mx-3" style="width: 250px"  id="formGroupExampleInput2" placeholder="telepon kontak">
</div>
<div class="p-3">
...
<script>
  export default{
    ...
    mounted() {
      ...
      this.$axios.get(`/api/web/penerbit/${this.$route.params.id}`)
    ...
    async updatePenerbit() {
      try {
        await this.$axios.put(`/api/web/penerbit/update/${this.$route.params.id}`, this.formData);
