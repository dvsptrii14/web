<template>
    ...
    <div class="d-flex justify-content-center align-items-center w-100 bg-success-subtle mt-5 mb-5">
  ...
  <input v-model="formData.Nama" type="text" class="form-control mx-3"  style="width: 250px;" id="formGroupExampleInput" placeholder="Nama">
  </div>
  <div class="mb-3">
  <label class="form-label p-3 my-0">Kelas</label>
  <input v-model="formData.Kelas" type="text" class="form-control mx-3"  style="width: 250px;" id="formGroupExampleInput" placeholder="Kelas">
  </div>
        <div class="mb-3">
  ...
  <a class="btn btn-secondary dropdown-toggle" style="margin-left: 20px" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Daftar Hadir
  </a>
