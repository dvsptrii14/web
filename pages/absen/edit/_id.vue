...
<input v-model="formData.tanggal" type="date" class="form-control mx-3"  style="width: 250px;" id="formGroupExampleInput" placeholder="tanggal">
</div>
<div class="mb-3">
<label class="form-label p-3 my-0">kelasjururan_ta_id</label>
<input v-model="formData.kelasjurusan_ta_id" type="text" class="form-control mx-3"  style="width: 250px"   id="formGroupExampleInput2" placeholder="kelasjurusan_ta_id">
</div>
<div class="mb-3">
<label class="form-label p-3 my-0">siswakelas_id</label>
<input v-model="formData.siswakelas_id" type="text" class="form-control mx-3" style="width: 250px"  id="formGroupExampleInput2" placeholder="siswakelas_id">
</div>
<div class="mb-3">
...
<input v-model="formData.keterangan" type="text" class="form-control mx-3" style="width: 250px"  id="formGroupExampleInput2" placeholder="keterangan">
</div>
<div class="p-3">
...
export default{
  ...
  mounted() {
    ...
    this.$axios.get(`/api/web/absen/${this.$route.params.id}`)
  ...
  async updateAbsen() {
    try {
      await this.$axios.put(`/api/web/absen/update/${this.$route.params.id}`, this.formData);
