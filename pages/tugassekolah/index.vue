    ...
    <div class="d-flex justify-content-center align-items-center w-auto bg-success-subtle mx-auto p-">
        <div class="card bg-success-subtle" style="width: 75%;">
            ...
            <nuxt-link to="/tugassekolah/create">
                <button style="border-radius: 10px" class="mx-2 my-3">Input Data Tugas Sekolah</button>
            </nuxt-link>

<div>
    <b-table striped hover :items = "setSiswa_kelas" :fields="field">
    <template v-slot:cell(action)="row">
        <b-button :to="{name:'tugassekolah-edit-id', params:{id:row.item.id}}">Edit</b-button>
