      ...
      <div class="card" style="width: 25rem; background-color: #d8efe9">
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <input
              v-model="formData.penulis_id"
              type="text"
              class="form-control mx-3"
              style="width: 250px"
              id="formGroupExampleInput2"
              placeholder="masukan penulis id"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              style="width: 250px"
              id="formGroupExampleInput"
              placeholder="masukan judul cover buku"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              style="width: 250px"
              id="formGroupExampleInput"
              placeholder="masukan ringkasan buku"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              v-model="formData.penerbit_id"
              type="text"
              class="form-control mx-3"
              style="width: 250px"
              id="formGroupExampleInput"
              placeholder="masukan penerbit id"
            />
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              style="width: 250px"
              id="formGroupExampleInput"
              placeholder="masukan link/pdf buku"
            />
          </div>
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/web/bacaan/${this.$route.params.id}`)
    ...
    async updateBacaan() {
      try {
        await this.$axios.put(
          `/api/web/bacaan/update/${this.$route.params.id}`,
          this.formData
        );
